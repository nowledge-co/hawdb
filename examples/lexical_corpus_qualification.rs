...
use skein::{
    SearchDocument, SearchLexicalTermPolicy, SearchOutOfCoreGenerationBuildOptions,
...
fn main() -> Result<()> {
    ...
    if args.len() != 5 {
        return Err("usage: lexical_corpus_qualification SOURCE_JSONL NEW_OUTPUT_ROOT EXPECTED_DOCUMENTS MAX_TERM_BYTES".into());
    }
