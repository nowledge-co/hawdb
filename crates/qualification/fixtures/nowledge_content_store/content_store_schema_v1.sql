...
CREATE TABLE content_anchors (anchor_id TEXT PRIMARY KEY, owner_kind TEXT NOT NULL, owner_id TEXT NOT NULL, content_doc_id TEXT NOT NULL REFERENCES content_documents(content_doc_id), target_kind TEXT NOT NULL, target_id TEXT NOT NULL, anchor_kind TEXT NOT NULL, message_id TEXT, order_index BIGINT, char_start BIGINT, char_end BIGINT, page BIGINT, chunk_id TEXT, quote_hash TEXT NOT NULL DEFAULT '', metadata_json TEXT NOT NULL DEFAULT '{}', created_at TEXT NOT NULL, content_message_id TEXT);
