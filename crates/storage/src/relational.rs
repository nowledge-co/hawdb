...
pub use index_shadow::{
    ...
    RelationalIndexShadowBuildReport, RelationalIndexShadowCheckpointReport,
    RelationalIndexShadowCheckpointStatus, RelationalIndexShadowConfig, RelationalIndexShadowError,
    RelationalIndexShadowManifest, RelationalIndexShadowReader,
    RelationalIndexShadowRecoveryStatus, RelationalIndexShadowWriter, RelationalIndexStatistics,
