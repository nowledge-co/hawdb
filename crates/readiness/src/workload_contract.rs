//! Host-neutral workload-fixture report contracts.
//!
//! The root facade owns graph and search execution. This module owns the
//! values it returns so qualification tooling can consume them independently.

use crate::nowledge_mem_query_report::NowledgeMemQueryExecutionPath;
use skein_nowledge_contracts::KnowledgeFanoutReasonCode;
