...
//! supplied static callback at the same point as the facade implementation.

use crate::field_plan::{projection_contains_aggregate, single_count_distinct_column};
...
pub fn format_relational_explain(
