...
pub use search::{
    ...
    SearchHit, SearchIndex, SearchLexicalArtifactBytes, SearchLexicalFeasibilityCoverage,
    ...
    SearchRebuildSummary, SearchResultSet, SearchRetrieverCandidateSetReport, SearchSegmentCache,
    SearchSegmentCacheSnapshot, SearchTopKScoreParity, SearchTruncationReasonCode,
