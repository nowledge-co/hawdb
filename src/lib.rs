...
pub use store::{
    ...
    ColumnarShadowRecoveryStatus, DatabaseDoctor, DegreeStatisticsConsistencyReport,
    DegreeStatisticsEntry, DegreeStatisticsKey, DerivedArtifactHealth, DerivedArtifactHealthReport,
    DerivedArtifactHealthState, DerivedArtifactKind, DerivedArtifactRebuildOptions,
    DerivedArtifactRepairPlan, DerivedArtifactRepairReport,
