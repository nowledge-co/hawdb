...
pub use skein_compat::{
    ...
    compatibility_query_inventory_to_json, enforce_external_shadow_adapter_smoke_requirements,
    ...
    external_shadow_value_from_json, is_self_shadow_command, nowledge_memory_core_fixture,
    nowledge_memory_core_inventory, should_run_shadow_ready, CompatibilityCheck,
    ...
    CypherExecutionMode, CypherFixtureCheck, CypherFixtureStatement, ExpectedErrorClass,
    ExpectedRows, ExternalShadowCommand, ExternalShadowProjectGraphReply,
