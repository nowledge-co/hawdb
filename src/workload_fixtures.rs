...
pub use skein_readiness::workload_contract::{
...
mod tests {
    ...
    fn root_facade_preserves_workload_contract_type_identity() {
        assert_eq!(
            TypeId::of::<crate::NowledgeGraphRouteWorkloadFixtureReport>(),
            TypeId::of::<skein_readiness::NowledgeGraphRouteWorkloadFixtureReport>(),
        );
        assert_eq!(
            TypeId::of::<crate::NowledgeGraphRouteWorkloadQueryReport>(),
            TypeId::of::<skein_readiness::NowledgeGraphRouteWorkloadQueryReport>(),
        );
    }
