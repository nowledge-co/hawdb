...
fn plan(query: &str, parameters: &BTreeMap<String, Value>) -> PhysicalPlan {
    let logical = skein_plan::plan_pipeline_query(query, parameters).unwrap();
    skein_optimizer::CascadesOptimizer::default().optimize(&logical)
}
    ...
    fn execute_vector_seed(
        ...
        Ok(VectorSeedExecutionOutput {
            ...
            report: skein_executor::VectorExecutionReport {
                backend: skein_executor::VectorExecutionBackend::ScalarFlat,
                compression_mode: skein_executor::VectorCompressionMode::Disabled,
                ...
                candidate_score_source: skein_executor::VectorScoreSource::RawVector,
                final_score_source: skein_executor::VectorScoreSource::RawVector,
