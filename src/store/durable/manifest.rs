...
use crate::store::{
    checkpoint_generation_file, checksum_bytes, encode_optional_sha256, encode_optional_u64,
    parse_optional_sha256, parse_optional_u64, parse_u64, safe_reclaim_commit_epoch,
    split_manifest_checksum, validate_storage_version, wal_generation_file, MANIFEST_HEADER_V1,
    STORAGE_VERSION,
};
...
pub(in crate::store) struct DurableManifest {
    pub(in crate::store) checkpoint_generation: Option<u64>,
    pub(in crate::store) checkpoint_encoded_len: Option<u64>,
    pub(in crate::store) checkpoint_encoded_checksum: Option<u64>,
    pub(in crate::store) checkpoint_encoded_sha256: Option<Sha256Digest>,
    pub(in crate::store) canonical_manifest_encoded_len: Option<u64>,
    pub(in crate::store) canonical_manifest_encoded_checksum: Option<u64>,
    pub(in crate::store) canonical_manifest_encoded_sha256: Option<Sha256Digest>,
    pub(in crate::store) canonical_adjacency_generation_artifacts:
        Option<CanonicalAdjacencyGenerationArtifacts>,
    pub(in crate::store) property_spill_manifest_encoded_len: Option<u64>,
    pub(in crate::store) property_spill_manifest_encoded_checksum: Option<u64>,
    pub(in crate::store) property_spill_manifest_encoded_sha256: Option<Sha256Digest>,
    pub(in crate::store) property_projection_manifest_encoded_len: Option<u64>,
    pub(in crate::store) property_projection_manifest_encoded_checksum: Option<u64>,
    pub(in crate::store) property_projection_manifest_encoded_sha256: Option<Sha256Digest>,
    pub(in crate::store) relational_row_generation_artifacts:
        Option<RelationalRowPageGenerationArtifacts>,
    pub(in crate::store) relational_overflow_generation_artifacts:
        Option<RelationalOverflowGenerationArtifacts>,
    pub(in crate::store) relational_index_generation_artifacts:
        Option<RelationalIndexGenerationArtifacts>,
    pub(in crate::store) append_generation_artifacts: Option<AppendGenerationArtifacts>,
    pub(in crate::store) wal_generation: u64,
    pub(in crate::store) checkpoint_epoch: u64,
    pub(in crate::store) checkpoint_commit_epoch: u64,
    pub(super) oldest_reader_commit_epoch: Option<u64>,
    pub(super) safe_reclaim_commit_epoch: u64,
    pub(in crate::store) wal_replay_start_lsn: u64,
    pub(super) next_lsn: u64,
    pub(super) source_scan_commit_epoch: Option<u64>,
    pub(super) source_scan_descriptor_checksum: Option<u64>,
}
...
pub(in crate::store) fn artifact_metadata_presence_consistent(
...
impl DurableManifest {
    pub(super) const fn initial_generation() -> Self {
        Self {
    ...
    pub(in crate::store) fn checkpoint_path(self, root: &Path) -> PathBuf {
        root.join(checkpoint_generation_file(
            self.checkpoint_generation.unwrap_or(self.checkpoint_epoch),
        ))
    }

    pub(in crate::store) fn wal_path(self, root: &Path) -> PathBuf {
        root.join(wal_generation_file(self.wal_generation))
    }

    pub(in crate::store) fn validate(self) -> Result<()> {
    ...
    pub(in crate::store) fn load(path: &Path) -> Result<Self> {
