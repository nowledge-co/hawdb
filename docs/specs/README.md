...
| Columnar canonical storage (node groups, deletion vectors, delta groups), durable declared indexes, the durable incremental projection framework (vector, lexical BM25, adjacency), relational unification, memory budget, and QoS | [`COLUMNAR_CANONICAL_AND_PROJECTION_SPEC.md`](COLUMNAR_CANONICAL_AND_PROJECTION_SPEC.md) | [`../STORAGE.md`](../STORAGE.md), [`../tla/README.md`](../tla/README.md), [`VECTORIZED_MORSEL_EXECUTION_SPEC.md`](VECTORIZED_MORSEL_EXECUTION_SPEC.md), [`POSTGRES_RELATIONAL_CONTENT_STORE_SPEC.md`](POSTGRES_RELATIONAL_CONTENT_STORE_SPEC.md) |
